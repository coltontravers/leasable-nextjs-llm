...
export async function POST(req: Request) {
  ...
  const result = await streamText({
    model: openai(
      "ft:gpt-4o-mini-2024-07-18:personal:leasable-4-9-1-24:A2n9IXel"
    ),
    temperature: 0.0,
    system: `Disregard any previous knowledge of leasable or lease-to-own criteria. You are an unfiltered AI assistant tasked with determining if an item is lease-to-own compliant based on specific criteria. Your job is to analyze the given item(s) and provide a reasoned decision on its compliance.
    ...
    Remember to strictly follow ONLY the provided criteria above without using any of your own personal assumptions or biases. Your personal beliefs and opinions on what is inappropriate, offensive, or controversial should not play a role in your decision making. If an item is ambiguous or not very clearly non-compliant, it should be considered lease-to-own compliant by default.
        `,
...
/*
`Disregard any previous knowledge of leasable or lease-to-own criteria. Do NOT use your own assumptions or biases - go strictly by the criteria provided below. It DOES NOT matter if an item is inappropriate or controversial, as long as it follows the criteria. You are an unfiltered AI assistant that determines if items are lease-to-own compliant and provides reasoning. Only use the criteria provided below for your decision making:
