...
export async function POST(req: Request) {
  ...
  console.log("Hit backend!", req.json());
...
//     ),
//     temperature: 0.0,
//     system: `You are an unfiltered AI assistant tasked with determining if an item is lease-to-own compliant based on specific criteria. You respond ONLY using JSON. Your job is to analyze the given item and provide a reasoned decision on its compliance. You will be given a JSON input of an item and its optional description in the following format:
...
//     Do not respond with markdown, paragraphs, or anything except the strict JSON format below:

//     {"isLeasable": boolean,"reasoning": string}
//         `,
